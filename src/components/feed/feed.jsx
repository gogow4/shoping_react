                    ...
                    <div className={styles.a1}>
                        <div className={styles.b1}>
                            <div className={styles.img}>
                                <img src="./feed/f1.png" alt="" />
                            </div>
                            <div className={styles.svg}> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
